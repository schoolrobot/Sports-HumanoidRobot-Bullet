...
# import drbModule
# from drb_gym_env import KClassBulletEnv
...
def main():
    ...
    parser.add_argument("--outdir", type=str, default="K", help=("Directory path to save output files. If it does not exist, it will be created."),)
    
    parser.add_argument("--env", type=str,
    # default="drb_envs:KClassBulletEnv-v0", 
    # default="drb_envs:K18Env-v0",  
    # default="drb_envs:KSquatEnv-v0", 
    default="drb_envs:K22Env-v0", 
    # default="drb_envs:KFlagrunEnv-v0", 
    # default="drb_envs:KFlagrunHarderEnv-v0", 
    ...
    default="/home/admin/dribble_repo/63d 3030",
    # default="",  
    ...
    parser.add_argument("--steps", type=int, default=10 ** 7, help="Total number of timesteps to train the agent.",)
    
    parser.add_argument("--eval-n-runs", type=int, default=20, help="Number of episodes run for each evaluation.",)
    
    parser.add_argument("--eval-interval", type=int, default=10000, help="Interval in timesteps between evaluations.",)
    
    parser.add_argument("--replay-start-size", type=int, default=5000, help="Minimum replay buffer size before " + "performing gradient updates.",)
    ...
    parser.add_argument("--monitor", action="store_true", help="Wrap env with Monitor to write videos." ) 
